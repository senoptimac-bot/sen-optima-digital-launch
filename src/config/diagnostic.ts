...
export const DIAGNOSTIC_QUESTIONS: DiagnosticQuestion[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    question: "Savez-vous où vous voulez être dans 12 mois ?",
    options: [
      { value: "yes", label: "Oui, objectifs clairs en tête", score: 3 },
      { value: "partial", label: "J'ai des idées, mais rien de précis", score: 2 },
  ...
  },
  {
    ...
    blockId: 5,
    blockName: "Vision & Discipline",
    question: "Suivez-vous des indicateurs chiffrés chaque mois ?",
    options: [
      { value: "yes", label: "Oui, tableau de bord en place", score: 3 },
      { value: "partial", label: "Quelques chiffres, sans structure", score: 2 },
      { value: "no", label: "Non, je ne mesure rien", score: 1 },
    ],
  },
  {
    id: "q27",
    blockId: 5,
    blockName: "Vision & Discipline",
    question: "Planifiez-vous vos semaines et vos actions ?",
    options: [
  ...
  },
  {
    ...
    blockId: 5,
    blockName: "Vision & Discipline",
    question: "Prenez-vous le temps d'analyser ce qui marche ou pas ?",
    options: [
      { value: "yes", label: "Oui, régulièrement", score: 3 },
      { value: "partial", label: "Quand j'y pense", score: 2 },
      { value: "no", label: "Jamais", score: 1 },
    ],
  },
  {
    ...
    blockId: 5,
    blockName: "Vision & Discipline",
    question: "Êtes-vous prêt à remettre en question vos habitudes ?",
    options: [
      { value: "yes", label: "Oui, totalement", score: 3 },
      { value: "partial", label: "Avec un peu de résistance", score: 2 },
      { value: "no", label: "Non, je préfère mes méthodes", score: 1 },
    ],
  },
  {
    id: "q30",
    blockId: 5,
    blockName: "Vision & Discipline",
    question: "Êtes-vous prêt à structurer votre activité maintenant ?",
    options: [
      { value: "yes", label: "Oui, c'est urgent pour moi", score: 3 },
      { value: "partial", label: "Peut-être bientôt", score: 2 },
      { value: "no", label: "Pas encore, je verrai plus tard", score: 1 },
    ],
  },
];
