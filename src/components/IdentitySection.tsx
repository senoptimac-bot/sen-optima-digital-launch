...
const IdentitySection = () => {
  return (
    <section id="identite" className="py-section-lg relative px-5 md:px-0">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
          ...
          >
            <h3 className="text-title text-foreground/60 mb-4 md:mb-6">
          ...
          <motion.div
            ...
            className="glass-card rounded-xl p-6 md:p-10"
          >
            <h3 className="text-title text-foreground mb-4 md:mb-6">
        ...
        >
          <Link
            to="/services"
            className="text-[13px] text-foreground/50 hover:text-accent active:text-accent transition-colors duration-300 uppercase tracking-widest py-3 min-h-[44px] flex items-center"
          >
