 ...
 */
const DiagnosticPayment = memo(({
  onPaymentComplete
}: DiagnosticPaymentProps) => {
  ...
  const features = ["30 questions adaptées au contexte sénégalais", "Analyse détaillée de votre maturité business", "Score par pilier stratégique", "Rapport personnalisé sous 24h"];
  return <section className="min-h-screen flex flex-col items-center justify-center px-4 py-16 md:py-24">
      <AnimatePresence mode="wait">
        {/* ÉTAPE 1 : Choix du paiement */}
        {step === "choice" && <motion.div key="choice" initial={{
        opacity: 0,
        y: 30
      }} animate={{
        opacity: 1,
        ...
        ease: "easeOut"
          ...
          delay: 0.3
              ...
              <div className="bg-primary/5 px-6 py-8 md:px-8 md:py-10 text-center border-b border-border/30">
                ...
                <div className="text-5xl md:text-6xl font-heading font-bold mb-2 text-accent">
                  10 000
              ...
              scale: 0.98
            }} onClick={handlePaymentChoice} className="w-full p-5 rounded-xl bg-[#1DC4FF] hover:bg-[#1DC4FF]/90 transition-all flex items-center justify-center gap-4 shadow-lg shadow-[#1DC4FF]/20 group">
                  <img src="/wave-logo.png" alt="Wave" className="h-7 w-auto object-contain brightness-0 invert" />
        ...
        ease: "easeOut"
          ...
          delay: 0.2
              ...
              <img src="/wave-logo.png" alt="Wave" className="h-12 w-auto object-contain" />
            </motion.div>
          ...
          scale: 0.98
        }} onClick={handlePaymentConfirmation} className="w-full max-w-sm mx-auto p-5 rounded-xl bg-foreground text-background font-heading font-bold text-lg flex items-center justify-center gap-3 transition-all hover:bg-foreground/90 shadow-lg">
          ...
          delay: 0.6
        }} onClick={() => setStep("choice")} className="mt-6 text-sm text-muted-foreground hover:text-foreground transition-colors font-subheading">
              ← Retour au paiement
            </motion.button>
          </motion.div>}
      </AnimatePresence>
